...
const BODY_REGIONS = [
  { id: 'head', label: 'Head', icon: '🧠', position: 'top-left' },
  { id: 'chest', label: 'Chest', icon: '🫁', position: 'mid-left' },
  { id: 'abdomen', label: 'Abdomen', icon: '🫃', position: 'bot-left' },
  { id: 'arms', label: 'Arms', icon: '💪', position: 'top-right' },
  { id: 'hands', label: 'Hands', icon: '🖐️', position: 'mid-right' },
  { id: 'legs', label: 'Legs', icon: '🦵', position: 'bot-right' },
];

// Light theme color palette
const REGION_COLOR = 0x34C98E; // Mint green for active
const BASE_COLOR   = 0xB0C8E8; // Soft periwinkle/slate for base mannequin
...
export default function HumanBody3D({ selectedRegion, onRegionSelect }) {
  ...
  useEffect(() => {
    ...
    function animate(now) {
      ...
      // Smooth, symmetric Y-axis rotation (vertical axis through head → belly)
