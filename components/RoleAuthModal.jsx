        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2 mb-6 p-1 rounded-xl bg-white/5 border border-white/10">
            <button
              ...
              className={`py-2 px-3 rounded-lg text-xs font-semibold font-display flex flex-col items-center gap-1 transition-all ${selectedRole === 'ambulance'
            ...
            <button
              ...
              className={`py-2 px-3 rounded-lg text-xs font-semibold font-display flex flex-col items-center gap-1 transition-all ${selectedRole === 'doctor'
            ...
            <button
              ...
              className={`py-2 px-3 rounded-lg text-xs font-semibold font-display flex flex-col items-center gap-1 transition-all ${selectedRole === 'hospital'
          ...
          <div className="space-y-3">
            <button
              ...
              className={`w-full py-3 px-4 rounded-xl font-bold text-sm text-white transition-all shadow-lg flex items-center justify-center gap-2 ${selectedRole === 'ambulance' ? 'bg-red-600 hover:bg-red-500 shadow-red-600/30' :
